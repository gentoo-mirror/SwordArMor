...
IUSE="
	256-color blink fading-colors +font-styles gdk-pixbuf iso14755 mouse
	+mousewheel +perl startup-notification unicode3 xft
"
RESTRICT="test"
...
src_prepare() {
	...
	use mouse || epatch "${FILESDIR}"/${P}-disable-mouse.patch
